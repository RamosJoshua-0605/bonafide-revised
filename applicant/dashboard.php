...
try {
    ...
    $interviewQuery = $pdo->prepare("
        SELECT i.interview_date AS date, 'Interview' AS type, i.interview_id AS id
    ...
    $offerQuery = $pdo->prepare("
        SELECT o.start_date AS date, 'Offer' AS type, o.offer_id AS id
    ...
    $deploymentQuery = $pdo->prepare("
        SELECT d.deployment_date AS date, 'Deployment' AS type, d.deployment_id AS id
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <?php if (count($interviewEvents) > 0): ?>
                                        ...
                                        <a href="view_interview.php?id=<?= htmlspecialchars($event['id']) ?>" class="d-block mb-2">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <?php if (count($offerEvents) > 0): ?>
                                        ...
                                        <a href="view_offer.php?id=<?= htmlspecialchars($event['id']) ?>" class="d-block mb-2">
                                            <?= htmlspecialchars($event['date']) ?> - <?= htmlspecialchars($event['type']) ?>
                                        </a>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <?php if (count($deploymentEvents) > 0): ?>
                                        ...
                                        <a href="view_deployment.php?id=<?= htmlspecialchars($event['id']) ?>" class="d-block mb-2">
                                            <?= htmlspecialchars($event['date']) ?> - <?= htmlspecialchars($event['type']) ?>
                                        </a>
                                        <?php endforeach; ?>
                                    <?php else: ?>
