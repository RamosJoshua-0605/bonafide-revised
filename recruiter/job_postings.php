        ...
        <div class="container mt-5">
            ...
            <form id="jobPostForm" action="" method="POST" novalidate>
                ...
                <div class="salary-container mb-3">
                    ...
                    <div id="salaryError" class="invalid-feedback" style="display:none;">Minimum salary must not exceed
                        maximum salary.</div>
                </div>
                ...
                <div class="age-container mb-3">
                    ...
                    <div id="ageError" class="invalid-feedback" style="display:none;">Minimum age must not exceed
                        maximum age.</div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="preferred_work_experience"
                        name="preferred_work_experience">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('includeRequirement').addEventListener('change', function() {
                ...
                if (this.checked) {
                    requirementSection.style.display =
                        'block'; // Show the section if checkbox is checked
                } else {
                    requirementSection.style.display =
                        'none'; // Hide the section if checkbox is unchecked
                    document.getElementById('requirementContainer').innerHTML =
                        ''; // Remove any added requirements
                }
            });
            ...
            `;
                ...
                newRequirement.querySelector('.removeRequirement').addEventListener('click',
                    function() {
